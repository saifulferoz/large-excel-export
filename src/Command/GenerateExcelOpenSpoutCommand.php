...
use App\Service\OpenSpoutGeneratorService;
...
#[AsCommand(
    name: 'app:generate-excel-openspout',
    description: 'Generates a memory-optimized 400,000-row Excel spreadsheet using OpenSpout.',
)]
class GenerateExcelOpenSpoutCommand extends Command
{
    public function __construct(
        private DataGeneratorService $dataGenerator,
        private OpenSpoutGeneratorService $openspoutGenerator
    ) {
        parent::__construct();
    }
    ...
    protected function execute(InputInterface $input, OutputInterface $output): int
    {
        ...
        $io->title('Starting OpenSpout Excel Generation');
        ...
        $outputPath = $outputDir.'/large_report_openspout.xlsx';

        $io->text('Initializing OpenSpout Writer...');
        ...
        $metrics = $this->openspoutGenerator->writeData($report, $outputPath, $generator);
        ...
        $io->success([
            'OpenSpout Excel file generated successfully!',
